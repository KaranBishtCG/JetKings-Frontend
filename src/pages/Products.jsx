  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl sm:text-[36px] leading-tight font-semibold tracking-tight">Products Management</h1>
          <p className="text-sm text-gray-500 mt-0.5">Manage and organize your base product inventory</p>
        </div>
        <button
          type="button"
