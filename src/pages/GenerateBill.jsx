        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-slate-200 bg-white px-4 py-4 shadow-sm">
            ...
            <div className="relative">
              ...
              />
              <MdKeyboardArrowDown size={20} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400" />
            </div>
          </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white px-4 py-4 shadow-sm">
            <div className="mb-3 flex items-center gap-2">
              ...
              <h2 className="text-base font-semibold text-blue-600">Product Type</h2>
            </div>
            <div className="relative max-w-[220px]">
              ...
              />
              <MdInventory2 size={16} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500" />
            </div>
          </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white px-4 py-4 shadow-sm">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {productCards.map((product) => (
                ...
                >
                  <div className="flex h-24 items-center justify-center bg-slate-200 text-[10px] text-slate-500">IMG</div>
                  <div className="p-2.5">
                    <p className="truncate text-[11px] font-semibold text-slate-700">{product.name}</p>
                    <p className="mt-1 text-xl leading-none font-bold text-blue-700">{product.price}</p>
                    <p className="mt-1 text-[9px] font-semibold uppercase tracking-wider text-slate-400">Buyer Price</p>
                  </div>
                </article>
              ))}
            </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
            <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3">
              ...
              <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-500">0 Items</span>
            </div>
            ...
            <div className="flex h-36 flex-col items-center justify-center border-t border-slate-200 bg-white text-center">
              ...
              <p className="mt-2 text-sm text-slate-400">Select products from the grid above to add to bill.</p>
            </div>
          </div>
        </div>
        ...
        <aside className="space-y-4">
          <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="px-4 py-4 text-center">
              ...
              <p className="mt-1 text-5xl font-bold leading-none text-blue-700">₹0.00</p>
            </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="mb-3 flex items-center gap-2">
              <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-blue-100 text-[11px] font-semibold text-blue-600">7</span>
              <h2 className="text-[15px] font-semibold uppercase tracking-wide text-blue-600">Live Preview</h2>
            </div>

            <div className="rounded-lg border border-slate-200 bg-white p-3 text-[9px] text-slate-500">
              <div className="flex items-start justify-between border-b border-slate-200 pb-2">
                <div>
                  <p className="text-[10px] font-bold tracking-wide text-blue-700">GENEXT SANITARY</p>
                  <p>GST: 23AACCG0000Z5</p>
                </div>
              ...
              <div className="border-t border-slate-200 pt-2">
                <div className="grid grid-cols-4 font-semibold text-slate-600">
                  <span>ITEM</span>
                  <span>QTY</span>
                  <span>QTY</span>
              ...
              <p className="border-t border-slate-200 pt-2 text-right font-semibold text-slate-700">TOTAL: ₹0.00</p>
            </div>
          </div>
        </aside>
      </section>
